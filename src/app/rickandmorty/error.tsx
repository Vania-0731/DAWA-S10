...
export default function RickAndMortyError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error('Error en Rick and Morty:', error);
  }, [error]);
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-blue-900 to-purple-900 flex items-center justify-center p-8">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-xl text-gray-300 mb-6">
          Parece que hay un problema con el universo de Rick and Morty. 
          Los personajes están siendo difíciles de encontrar.
        </p>
        ...
        <p className="text-gray-400 text-sm mt-8">
          Si el problema persiste, puede ser que la API de Rick and Morty esté temporalmente fuera de servicio.
        </p>
      </div>
    </div>
  );
